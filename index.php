<?php
//Script Author: NTM https://t.me/ntmpro
	include 'config.php';
...
<body onload="ccgen();  onLoadChks();"style="background: <?php echo $theme_background ?>;">
	<div class="container" id="container">
		...
		<div class="footer" id="footer"><center><p style="color: <?php echo $theme_text ?>">NTM</p></center></div>
	</div>
				...
				<div class="modal-body" style="background: <?php echo $theme_background ?>">
					...
					<div name="howto" id="howto">
						<center >
							...
							<h6 style="color: <?php echo $theme_text ?>;">[1] Open our Telegram Bot: <a href="https://t.me/ntm6gbot" target="_blank">@ntm6gbott</a>.
	...
	<script src="./assets/js/NTM.js"></script>
